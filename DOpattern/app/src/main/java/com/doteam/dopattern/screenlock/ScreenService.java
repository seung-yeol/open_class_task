...
public class ScreenService extends Service {
    ...
    public void onCreate() {
        ...
        IntentFilter mfilter = new IntentFilter(Intent.ACTION_USER_PRESENT);
      ...
      //        KReceiver = new OnKeyDown();
//        IntentFilter KFilter = new IntentFilter(Intent.ACTION_MEDIA_BUTTON);
//        pFilter.addAction(Intent.EXTRA_KEY_EVENT);
//
//        registerReceiver(KReceiver, KFilter);
